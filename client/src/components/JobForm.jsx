        ...
        <>
            ...
            <form onSubmit={handleForm} autoComplete="off">
                <div className="input-group mb-3">
                    ...
                    <input type="text" name="name" defaultValue={job.name} className="form-control" required={true}/>
                </div>
                <div className="input-group mb-3">
                    <span className="input-group-text text-bg-light">Interval (seconds)</span>
                    <input type="number" name="interval" defaultValue={job.interval} className="form-control" min={0}
                           required={true}/>
                </div>
                <div className="input-group mb-3">
